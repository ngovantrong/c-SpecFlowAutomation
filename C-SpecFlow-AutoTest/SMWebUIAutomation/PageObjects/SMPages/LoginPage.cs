...
namespace SMWebUIAutomation.PageObjects
{
    internal class LoginPage : BasePage
    {
        ...
        protected By ErrorMessage => By.XPath("//div[@class='validation-summary-errors']");
        ...
        public void VerifyErrorMessageDisplayed(string expected_message)
        {
            WaitUntilElementIsVisible(this.ErrorMessage);
            string actual_message = Driver.FindElement(this.ErrorMessage).Text;
